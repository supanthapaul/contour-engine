...
public class Texture {
    ...
    public Texture(int width, int height) {
        ...
        // allocate the texture in memory without data
    ...
    public boolean equals(Object o) {
        ...
        return this.width == oTex.getWidth() && this.height == oTex.getHeight() && this.texID == oTex.getId() &&
                this.filepath.equals(oTex.getFilepath());
    }
}
